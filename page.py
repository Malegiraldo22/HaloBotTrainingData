...
def analyze_plot(plot_function):
    ...
    response = img_model.generate_content(["Use the plot and make an analysis about the data shown in it, using a videogame context, do not calculate averages to do the analysis", temp_plot], stream=True)
    response.resolve()
...
6. How should the player reduce its negative stats without altering the individual play style assumed in point 5?
